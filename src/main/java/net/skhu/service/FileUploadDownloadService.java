...
import net.skhu.exception.FileDownloadException;
import net.skhu.property.FileUploadProperties;
import net.skhu.repository.FileDAO;
@Service
public class FileUploadDownloadService {
    ...
    public UploadFile storeFile(MultipartFile file) throws FileUploadException {
